            ...
            <div class="col-md-3 col-lg-3 item mb-3">
                <div class="card shadow" style="background-color: #e3e3e3; border: gray 1px;">
                    <div class="pl-3 pb-2 mt-2">
                        <i class="fa fa-trophy pl-5" style="margin-left: 150px" aria-hidden="true"></i>
                        <span style="font-weight: bold; padding-left:20px">Gold</span>
                    </div>
                    <div class="d-flex">
                        <img class="rounded-circle ml-3 mb-2" src="../assets/img/1.jpg"
                            style="max-width: 100px; max-height:100px; margin-right: 10px;">
                        <div class="mt-3" align="left">
                            <h3 class="text-dark">Ben Johnson</h3>
                            <h6 class="text-dark">Tukang Elektronik</h6>
                        </div>
                    </div>
                    <div class="d-flex mb-2 justify-content-start">
                        <div class="col-7 ml-0"><i class="fa fa-map-marker pr-3" aria-hidden="true"></i>Surabaya</div>
                        <div class="col-5 pl-5"><i class="fa fa-star pr-3 text-warning" aria-hidden="true"></i>4/5</div>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-lg-3 item mb-3">
